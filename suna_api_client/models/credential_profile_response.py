...
class CredentialProfileResponse(BaseModel):
    ...
    config_keys: List[StrictStr]
    is_active: StrictBool
    is_default: StrictBool
    created_at: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["profile_id", "mcp_qualified_name", "profile_name", "display_name", "config_keys", "is_active", "is_default", "created_at", "updated_at"]

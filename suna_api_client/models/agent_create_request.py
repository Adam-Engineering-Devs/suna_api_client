...
class AgentCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "system_prompt", "configured_mcps", "custom_mcps", "agentpress_tools", "is_default", "profile_image_url", "icon_name", "icon_color", "icon_background"]

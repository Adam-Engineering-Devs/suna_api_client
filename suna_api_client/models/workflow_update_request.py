...
class WorkflowUpdateRequest(BaseModel):
    ...
    trigger_phrase: Optional[StrictStr] = None
    is_default: Optional[StrictBool] = None
    status: Optional[StrictStr] = None
    steps: Optional[List[WorkflowStepRequest]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "trigger_phrase", "is_default", "status", "steps"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if trigger_phrase (nullable) is None
        # and model_fields_set contains the field
        if self.trigger_phrase is None and "trigger_phrase" in self.model_fields_set:
            _dict['trigger_phrase'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trigger_phrase": obj.get("trigger_phrase"),
            "is_default": obj.get("is_default"),
            "status": obj.get("status"),
            "steps": [WorkflowStepRequest.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj

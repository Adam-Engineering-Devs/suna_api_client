...
class BulkDeleteProfilesResponse(BaseModel):
    ...
    failed_profiles: Optional[List[StrictStr]] = None
    message: StrictStr
    __properties: ClassVar[List[str]] = ["success", "deleted_count", "failed_profiles", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed_profiles": obj.get("failed_profiles"),

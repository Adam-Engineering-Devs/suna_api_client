...
class ConnectionTokenResponse(BaseModel):
    ...
    external_user_id: Optional[StrictStr] = ''
    app: Optional[StrictStr] = None
    expires_at: Optional[StrictStr] = None
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "link", "token", "external_user_id", "app", "expires_at", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "link": obj.get("link"),
            "token": obj.get("token"),
            "external_user_id": obj.get("external_user_id") if obj.get("external_user_id") is not None else '',
            "app": obj.get("app"),

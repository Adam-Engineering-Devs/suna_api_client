...
class KnowledgeBaseListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entries", "total_count", "total_tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [KnowledgeBaseEntryResponse.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,

...
class MarketplaceTemplatesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["templates", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": MarketplacePaginationInfo.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj

...
# Custom function to process streaming lines
def process_stream_line(line: str):
    """Custom function to process each streaming line"""
    # You can add custom processing here
    # For example, parse JSON, filter content, save to file, etc.
    print(f"[RAW] {line}")
...
with suna_api_client.ApiClient(
    ...
    try:
        ...
        # Now stream the response using the custom module with processing
        print("\n--- Starting Stream with Custom Processing ---")
        
        # Use the new custom streaming function (generator pattern with processing)
